            ...
            <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?= __('Perfis') ?></li>
                    </ol>
                    <hr>
                </nav>
            </div>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-s12">
                <h1 class="page-title m-0"><?= __('Perfis') ?></h1>
            </div>
        </div>
    </div>
</div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                            ...
                                            <?php if (AccessChecker::hasPermission($loggedUserId, 'Roles/edit')): ?>
                                                <a href="#" class="btn btn-edit btn-sm" data-toggle="modal" data-target="#editModal-<?= $role->id ?>"><i class="far fa-address-card"></i></a>
                                            <?php endif; ?>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="deleteModalLabel-<?= $role->id ?>"><?= __('Confirmar Exclusão') ?></h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <p><?= __('Você tem certeza que deseja excluir # {0}?', $role->name) ?></p>
                                                </div>
                                                <div class="modal-footer justify-content-between">
                                                    <button type="button" class="btn modalCancel" data-dismiss="modal">Cancelar</button>
                                                    <?= $this->Form->postLink(__('Excluir'), ['action' => 'delete', $role->id], ['class' => 'btn modalDelete', 'id' => 'deleteButton-' . $role->id, 'data-id' => $role->id]) ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
